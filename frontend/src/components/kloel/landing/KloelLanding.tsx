...
function MultiChannel() {
  ...
  return (
    <div ref={ref}>
      <div style={{display:"grid",gridTemplateColumns:"var(--c3)",gap:10}} className="grid3">{renderPanel("wa")}{renderPanel("ig")}{renderPanel("em")}</div>
    ...
    <div style={{background:V,color:"#E0DDD8",fontFamily:F,overflowX:"hidden"}}>
      ...
      <footer style={{padding:"36px 24px"}}>
        <div style={{maxWidth:1100,margin:"0 auto",textAlign:"center"}}>
          <Link href="/" style={{fontSize:14,fontWeight:700,color:"#E0DDD8",textDecoration:"none",cursor:"pointer"}}>Kloel</Link>
