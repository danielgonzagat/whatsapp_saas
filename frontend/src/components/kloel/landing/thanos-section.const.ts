...
export const THANOS_STYLES = [
  ...
  '.thanos-icons span{display:grid;place-items:center;aspect-ratio:1;border-radius:16px;background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.06);box-shadow:0 14px 38px rgba(0,0,0,.2)}',
  '.thanos-icons img{width:72%;height:72%;object-fit:contain;display:block;opacity:.68;filter:saturate(.88)}',
  '.thanos-icons--dusting span,.thanos-icons--exit span{visibility:hidden}.thanos-icons--exit{opacity:0}',
