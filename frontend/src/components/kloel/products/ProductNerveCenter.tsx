...
export default function ProductNerveCenter({
  ...
  // Save handler — updateProduct calls apiFetch internally
            ...
            {PLANS.map((pl: any, i: number) => (
              <div
                ...
                style={{
                  ...
                  gridTemplateColumns: '1fr 2fr .6fr .8fr .7fr .7fr .7fr 1.2fr',
                  padding: '12px 16px',
                  borderBottom: i < PLANS.length - 1 ? `1px solid ${V.b}` : 'none',
                  alignItems: 'center',
                }}
              >
    ...
    return (
      <>
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 16 }}>
          ...
          <Bt primary onClick={handleNewCheckout}>
            + Novo checkout
          </Bt>
        </div>
        <div
            ...
            CKS.map((ck: any, i: number) => (
              ...
              >
                ...
                <div style={{ display: 'flex', gap: 3, flexWrap: 'wrap' }}>
                  {ck.mt.map((m: string) => (
                    <Bg key={m} color={m === 'BOLETO' ? V.pk : m === 'PIX' ? V.g2 : V.bl}>
                      {m}
                    </Bg>
                  ))}
                </div>
  ...
  function CkConfig() {
    ...
    const handleCkSave = async () => {
      ...
      try {
        ...
        console.error('Checkout config save error:', e);
      } finally {
        setCkSaving(false);
      }
    };
