...
export const CLOSE_FILL = KLOEL_THEME.error;
export const CLOSE_BORDER = KLOEL_THEME.error;
export const GREEN_FILL = KLOEL_THEME.success;
export const GREEN_BORDER = KLOEL_THEME.success;
