            ...
            >
              {detailEditing ? (
                <input
                  ...
                  style={{ ...inputStyle, fontSize: 15, fontWeight: 700, flex: 1, marginRight: 8 }}
                  autoFocus
                />
              ) : (
              ...
              {detailEditing ? (
                <>
                  <button
                    ...
                    disabled={detailSaving || !editTitle.trim()}
                    style={{
                      ...btnStyle,
                      background: '#E85D30',
                      color: '#fff',
                      flex: 1,
                      opacity: detailSaving || !editTitle.trim() ? 0.5 : 1,
                    }}
                  >
                ...
                <>
                  <button
                    ...
                    style={{ ...btnStyle, background: '#19191C', color: '#E0DDD8', flex: 1 }}
                  >
                    Editar
                  </button>
                  {confirmDelete ? (
                    ...
                    <button
                      ...
                      style={{ ...btnStyle, background: '#19191C', color: '#EF4444' }}
                    >
                      Excluir
                    </button>
                  )}
