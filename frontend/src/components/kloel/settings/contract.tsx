...
export const kloelSettingsClass = {
  ...
  modalSurface: 'w-full rounded-md border border-[#222226] bg-[#111113] p-6 shadow-2xl shadow-black/40',
  modalOverlay: 'fixed inset-0 z-[70] flex items-center justify-center bg-black/60 backdrop-blur-sm',
  cardButton:
...
export function SettingsMetricTile({ className, children, ...props }: HTMLAttributes<HTMLDivElement>) {
  return (
...
export function SettingsSwitchRow({
  ...
  return (
    <div className={cn('flex items-center justify-between gap-4 rounded-md border border-[#19191C] bg-[#0A0A0C] px-4 py-4', className)}>
