    ...
    <div style={{ opacity: 1 }}>
      ...
      <div style={{ position: 'relative', padding: '32px 0', ...mb(24) }}>
        ...
        <div style={{ textAlign: 'center', position: 'relative' }}>
          ...
          <div style={{ ...mono(48, 700), color: GREEN, letterSpacing: '-0.02em' }}>
            {item.commission}%
          </div>
        ...
        <div style={{ display: 'flex', gap: 20, ...mt(16) }}>
          {[
            ...
            <div key={l}>
              ...
              <div style={{ ...mono(16, 600), color: 'var(--app-text-primary)', ...mt(2) }}>
                {v}
              </div>
            </div>
          ))}
      ...
      <div style={{ ...cGreen, padding: 20, ...mb(16) }}>
        ...
        >
          ...
          {item.rating || 0}
          /5) e comissao de {item.commission || 0}
          {kloelT('%. Com base no seu publico, estimamos ganhos de')} {fmtBRL(p30)}{' '}
