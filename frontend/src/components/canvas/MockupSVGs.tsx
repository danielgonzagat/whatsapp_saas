...
export const PhoneSVG: React.FC<PhoneProps> = ({ c1, c2, story }) => (
  <svg width="48" height="82" viewBox="0 0 48 82" fill="none">
    <rect x="1" y="1" width="46" height="80" rx="8" fill="#1A1A1D" stroke="#2A2A2E" strokeWidth="1"/>
    ...
    {!story && (
      <>
        ...
        <circle cx="9" cy="53" r="1.8" fill="none" stroke="rgba(255,255,255,0.3)" strokeWidth="0.7"/>
        <circle cx="15" cy="53" r="1.8" fill="none" stroke="rgba(255,255,255,0.3)" strokeWidth="0.7"/>
    ...
    {story && (
      <>
        ...
        <circle cx="10" cy="17" r="3" fill="rgba(255,255,255,0.2)" stroke="rgba(255,255,255,0.3)" strokeWidth="0.5"/>
...
export const DesktopSVG: React.FC<DesktopProps> = ({ c1, c2, chart }) => (
  <svg width="82" height="54" viewBox="0 0 82 54" fill="none">
    <rect x="1" y="1" width="80" height="46" rx="4" fill="#1A1A1D" stroke="#2A2A2E" strokeWidth="1"/>
    ...
    {chart ? (
      <>
        {[22, 28, 34, 40, 46, 52, 58].map((x, i) => (
          <rect key={i} x={x} y={32 - [6, 10, 14, 8, 16, 12, 7][i]} width="4.5"
            height={[6, 10, 14, 8, 16, 12, 7][i]} rx="1"
...
export const DocSVG: React.FC<MockupProps> = ({ c1, c2 }) => (
  <svg width="44" height="60" viewBox="0 0 44 60" fill="none">
    <rect x="1" y="1" width="42" height="58" rx="3" fill="#1A1A1D" stroke="#2A2A2E" strokeWidth="1"/>
    ...
    <rect x="7" y="24" width="30" height="14" rx="2" fill={`url(#dc${c1.slice(1)})`} opacity="0.5"/>
...
export const SquareSVG: React.FC<MockupProps> = ({ c1, c2 }) => (
  <svg width="56" height="56" viewBox="0 0 56 56" fill="none">
    ...
    <circle cx="28" cy="28" r="5" fill="rgba(255,255,255,0.08)" stroke="rgba(255,255,255,0.15)" strokeWidth="0.5"/>
