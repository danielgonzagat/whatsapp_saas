    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          >
            Plano ID: <span style={{ fontFamily: "'JetBrains Mono', monospace", color: FAINT }}>{planId}</span>
          </p>
        </div>
              ...
              <div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <input
                    ...
                    value={state.chatColor}
                    onChange={(e) => set("chatColor", e.target.value)}
                    style={{ ...inputStyle, maxWidth: 120, fontFamily: "'JetBrains Mono', monospace", fontSize: 12 }}
                  />
                </div>
              </div>
