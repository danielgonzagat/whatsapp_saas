...
export const POPULAR_BANK_CODES = new Set([1, 33, 77, 104, 212, 237, 260, 290, 323, 336, 341, 380, 422, 748, 756]);
...
export const BRAZILIAN_BANKS: BrazilianBank[] = [
  ...
  { code: 4, name: 'BCO DO NORDESTE DO BRASIL S.A.', fullName: 'Banco do Nordeste do Brasil S.A.', ispb: '07237373' },
  { code: 10, name: 'CREDICOAMO', fullName: 'Credicoamo Crédito Rural Cooperativa', ispb: '81723108' },
  { code: 12, name: 'BCO INBURSA', fullName: 'Banco Inbursa S.A.', ispb: '04866275' },
  { code: 21, name: 'BANESTES S.A.', fullName: 'Banestes S.A. Banco do Estado do Espírito Santo', ispb: '28127603' },
  ...
  { code: 37, name: 'BCO DO ESTADO DO PA S.A.', fullName: 'Banco do Estado do Pará S.A.', ispb: '04913711' },
  { code: 41, name: 'BANRISUL', fullName: 'Banco do Estado do Rio Grande do Sul S.A.', ispb: '92702067' },
  { code: 47, name: 'BCO DO EST. DE SE S.A.', fullName: 'Banco do Estado de Sergipe S.A.', ispb: '13009717' },
  ...
  { code: 69, name: 'CREFISA S.A.', fullName: 'Crefisa S.A. Crédito, Financiamento e Investimentos', ispb: '61033106' },
  { code: 70, name: 'BRB - BCO DE BRASILIA S.A.', fullName: 'BRB - Banco de Brasília S.A.', ispb: '00000208' },
  ...
  { code: 84, name: 'UNIPRIME NORTE DO PARANÁ', fullName: 'Uniprime Norte do Paraná', ispb: '02398976' },
  { code: 85, name: 'COOPCENTRAL AILOS', fullName: 'Cooperativa Central de Crédito - Ailos', ispb: '05463212' },
  { code: 89, name: 'CCR REG MOGIANA', fullName: 'Cooperativa de Crédito Rural da Região da Mogiana', ispb: '62109566' },
  ...
  { code: 102, name: 'XP INVESTIMENTOS', fullName: 'XP Investimentos CCTVM S.A.', ispb: '02332886' },
  ...
  { code: 119, name: 'BCO WESTERN UNION', fullName: 'Banco Western Union do Brasil S.A.', ispb: '13720915' },
  ...
  { code: 133, name: 'CRESOL CONFEDERAÇÃO', fullName: 'Confederação Nacional das Cooperativas Centrais de Crédito e Economia Familiar e Solidária - Cresol Confederação', ispb: '10398952' },
  { code: 136, name: 'CONF NAC COOP CENTRAIS UNICRED', fullName: 'Unicred do Brasil', ispb: '00315557' },
  { code: 174, name: 'PEFISA S.A.', fullName: 'Pefisa S.A. - Crédito, Financiamento e Investimento', ispb: '43180355' },
  ...
  { code: 260, name: 'NU PAGAMENTOS S.A.', fullName: 'Nu Pagamentos S.A. (Nubank)', ispb: '18236120' },
  { code: 274, name: 'BMP SCMEPP LTDA', fullName: 'Money Plus SCMEPP Ltda', ispb: '11581339' },
  { code: 280, name: 'WILL FINANCEIRA S.A.', fullName: 'Avista S.A. Crédito, Financiamento e Investimento (Will Bank)', ispb: '23862762' },
  { code: 290, name: 'PAGSEGURO S.A.', fullName: 'PagSeguro Internet S.A. (PagBank)', ispb: '08561701' },
  { code: 318, name: 'BCO BMG S.A.', fullName: 'Banco BMG S.A.', ispb: '61186680' },
  { code: 323, name: 'MERCADO PAGO', fullName: 'Mercado Pago - Instituição de Pagamento', ispb: '10573521' },
  { code: 332, name: 'ACESSO SOLUÇÕES', fullName: 'Acesso Soluções de Pagamento S.A. (Will Bank)', ispb: '13140088' },
  ...
  { code: 389, name: 'BCO MERCANTIL DO BRASIL S.A.', fullName: 'Banco Mercantil do Brasil S.A.', ispb: '17184037' },
  { code: 399, name: 'KIRTON BANK S.A.', fullName: 'Kirton Bank S.A. - Banco Múltiplo', ispb: '01701201' },
  { code: 403, name: 'CORA SCD S.A.', fullName: 'Cora Sociedade de Crédito Direto S.A.', ispb: '37880206' },
  { code: 422, name: 'BCO SAFRA S.A.', fullName: 'Banco Safra S.A.', ispb: '58160789' },
  { code: 600, name: 'BCO LUSO BRASILEIRO S.A.', fullName: 'Banco Luso Brasileiro S.A.', ispb: '59118133' },
  { code: 604, name: 'BCO INDUSTRIAL DO BRASIL S.A.', fullName: 'Banco Industrial do Brasil S.A.', ispb: '31895683' },
  ...
  { code: 652, name: 'ITAÚ UNIBANCO HOLDING S.A.', fullName: 'Itaú Unibanco Holding S.A.', ispb: '60872504' },
  ...
  { code: 655, name: 'BCO VOTORANTIM S.A.', fullName: 'Banco Votorantim S.A. (Neon)', ispb: '59588111' },
  ...
  { code: 741, name: 'BCO RIBEIRÃO PRETO S.A.', fullName: 'Banco Ribeirão Preto S.A.', ispb: '00517645' },
  ...
  { code: 752, name: 'BCO BNP PARIBAS BRASIL S.A.', fullName: 'Banco BNP Paribas Brasil S.A.', ispb: '01522368' },
  { code: 755, name: 'BOFA MERRILL LYNCH', fullName: 'Bank of America Merrill Lynch Banco Múltiplo S.A.', ispb: '62073200' },
  { code: 756, name: 'SICOOB', fullName: 'Banco Cooperativo do Brasil S.A. (Sicoob)', ispb: '02038232' },
  { code: 757, name: 'BCO KEB HANA DO BRASIL S.A.', fullName: 'Banco KEB Hana do Brasil S.A.', ispb: '02318507' },
];
