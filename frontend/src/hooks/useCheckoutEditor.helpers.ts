...
/**
 * Pure helpers extracted from useCheckoutEditor.ts (Wave 88 — Subagent C).
 *
 * All exports are deterministic, side-effect-free, and trivially testable.
 * The hook re-exports `DEFAULT_CONFIG` and the public types to preserve the
 * existing import surface (notably `useCheckoutEditor.test.ts`).
 */
