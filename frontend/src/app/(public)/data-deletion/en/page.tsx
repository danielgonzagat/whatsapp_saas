  ...
  return (
    ...
    >
      <LegalSection id="how-it-works" title="1. How deletion works">
        <p>
          Once we receive a valid deletion request, we create an internal record, revoke sessions and integrations, anonymize or delete
          non-required operational data, and retain only the minimum data required for legal, tax, antifraud, and security obligations.
        </p>
      ...
      <LegalSection id="self-service" title="2. Self-service inside Kloel">
        <p>
          When enabled for your account, you may request deletion at <strong>app.kloel.com → Settings → Privacy → Delete account</strong>.
        </p>
      </LegalSection>
      <LegalSection id="facebook" title="3. Facebook/Meta deletion flow">
        <p>
          If you used Facebook authentication or connected Meta assets, removing Kloel from your connected Facebook apps may trigger our
          deletion callback at <strong>{legalConstants.urls.facebookDeletion}</strong>.
        </p>
        <p>
          After the signed callback is received, Kloel creates a deletion request, generates a confirmation code, and exposes progress at{' '}
          <strong>/data-deletion/status/{'{code}'}</strong>.
        </p>
      </LegalSection>
      <LegalSection id="email" title="4. Email request">
        <p>
          You may also email <strong>{legalConstants.company.emailDpo}</strong> with the subject <strong>&quot;Data deletion request&quot;</strong>.
        </p>
      </LegalSection>
