  ...
  return (
    ...
    >
      <LegalSection id="who-we-are" title="1. Who we are">
        <p>
          The data controller for the personal data covered by this policy is <strong>{company.legalName}</strong>, trade name{' '}
          <strong>{company.tradeName}</strong>, registered under Brazilian CNPJ <strong>{company.cnpj}</strong>, located at{' '}
          {company.addressLine1}, {company.addressLine2}.
        </p>
        <p>
          Our primary privacy contact is <strong>{company.emailDpo}</strong>. Operational support requests may be sent to{' '}
      ...
      <LegalSection id="sharing" title="4. Sharing with third parties">
        ...
        />
        <p>
          We do not sell personal data. We only share personal data with service providers, regulated payment processors, and public
          authorities when lawfully required.
        </p>
      </LegalSection>

      <LegalSection id="cookies" title="5. Cookies">
        <p>
          We use essential cookies for session continuity, security, fraud prevention, and user preferences. Optional analytics and
          marketing cookies depend on configuration and, where applicable, consent. See <a href={legalConstants.urls.cookies}>/cookies</a>.
        </p>
      </LegalSection>
      ...
      <LegalSection id="rights" title="8. Data subject rights">
        <p>
          You may request access, correction, deletion, portability, restriction, revocation of consent, and additional information on
          sharing, subject to the applicable law. We aim to respond within 15 days unless a different legal timeline applies.
        </p>
      </LegalSection>

      <LegalSection id="transfers" title="9. International transfers">
        <p>
          Some of our infrastructure and subprocessors are located outside Brazil. We rely on contractual and organizational safeguards,
          including standard contractual clauses where appropriate.
        </p>
      </LegalSection>

      <LegalSection id="children" title="10. Children">
        <p>
          Kloel is not directed to children under 18. If we detect incompatible use, we may suspend the account and delete non-required
          data.
        </p>
      </LegalSection>
      ...
      <LegalSection id="changes" title="11. Changes to this policy">
        <p>
          We may update this policy to reflect product, legal, security, or infrastructure changes. Material updates may be announced by
          email, in-product notice, or another reasonable channel.
        </p>
      </LegalSection>

      <LegalSection id="contact" title="12. Contact and supervisory channels">
        <p>
          Privacy matters: <strong>{company.emailDpo}</strong>. Support matters: <strong>{company.emailSupport}</strong>. You may also
          contact the ANPD or your local supervisory authority if needed.
        </p>
      </LegalSection>

      <LegalSection id="google-use" title="13. Google information use">
        <p>
          Kloel&apos;s use and transfer of information received from Google APIs will adhere to the Google API Services User Data Policy,
        ...
        />
        <p>
          We do not use Google API data to train AI models, we do not sell Google API data, and we do not allow human access except
          with explicit consent, for security/operations, or when legally required.
        </p>
      </LegalSection>
      ...
      <LegalSection id="meta-use" title="14. Meta information use">
        ...
        />
        <p>
          Meta data is retained only for as long as necessary to operate the service. Users may revoke access in Facebook settings or
          through <a href={legalConstants.urls.dataDeletionEn}>{legalConstants.urls.dataDeletionEn}</a>.
        </p>
      </LegalSection>
    </LegalDocument>
  );
