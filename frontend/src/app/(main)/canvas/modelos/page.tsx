      ...
      <div style={{ maxWidth: 580, margin: '0 auto 20px' }}>
        ...
        <div style={{ display: 'flex', gap: 6, marginTop: 10, flexWrap: 'wrap' }}>
          <button
            ...
            style={{
              padding: '4px 10px',
              background: !activeTag ? colors.ember.primary : '#E85D3010',
              border: `1px solid ${!activeTag ? colors.ember.primary : '#E85D3020'}`,
              borderRadius: 4,
          ...
          {TEMPLATE_TAGS.map((t) => (
            <button
              ...
              style={{
                padding: '4px 10px',
                background: activeTag === t ? colors.ember.primary : '#E85D3010',
                border: `1px solid ${activeTag === t ? colors.ember.primary : '#E85D3020'}`,
                borderRadius: 4,
