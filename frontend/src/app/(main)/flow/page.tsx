...
import { Plus, FileText, Play, Clock, Loader2, RefreshCw, RotateCcw, LayoutTemplate, Sparkles } from 'lucide-react';
          ...
          <div className="p-6 overflow-y-auto h-full">
            ...
            {templatesLoading && templates.length === 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-20 gap-4">
                ...
                <p className="text-[#3A3A3F] text-xs">Templates criados por admins aparecerao aqui</p>
              </div>
            ) : (
                    ...
                    >
                      ...
                      <div className="p-4 flex-1 flex flex-col gap-3">
                        <div className="flex items-start justify-between gap-2">
                          <h3 className="text-sm font-semibold text-[#E0DDD8] leading-tight">{tmpl.name}</h3>
                          <span
                        ...
                        {tmpl.description && (
                          <p className="text-xs text-[#6E6E73] leading-relaxed">{tmpl.description}</p>
                        )}
                        ...
                        <button
                          ...
                          style={{
                            background: isDownloaded ? 'rgba(16,185,129,0.15)' : 'rgba(232,93,48,0.15)',
          ...
          <div className="p-6 space-y-4 overflow-y-auto h-full">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                {execError && (
                  <span className="text-sm text-[#EF4444]">{execError}</span>
                )}
                <button
