          ...
          return (
            <div
              ...
              style={{
                ...
                padding: '14px 16px',
                background: isActive
                  ? `rgba(${cat.color === colors.accent.webb ? '78, 122, 224' : cat.color === colors.state.success ? '45, 212, 160' : cat.color === colors.accent.gold ? '201, 168, 76' : '123, 94, 167'}, 0.08)`
                  : colors.background.space,
