    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: '12px', color: '#8A8A8E', textTransform: 'uppercase', marginBottom: '6px', fontWeight: 500 }}>
            Numero do pedido
          </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '13px', color: '#8A8A8E', marginBottom: '12px', fontWeight: 600, textTransform: 'uppercase' }}>
            Resumo
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '14px', color: '#E8E6E1', marginBottom: '8px' }}>
            <span>Status</span>
            <span style={{ color: accent, fontWeight: 600 }}>
              {data?.status === 'PAID' ? 'Pago' : data?.status === 'PENDING' ? 'Pendente' : data?.status || '...'}
            </span>
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '14px', color: '#E8E6E1' }}>
            <span>Metodo</span>
        ...
        <div style={{
          ...
          <p style={{ margin: 0 }}>
            Prazo estimado de entrega: <strong style={{ color: '#E8E6E1' }}>5 a 10 dias uteis</strong>
          </p>
        </div>
