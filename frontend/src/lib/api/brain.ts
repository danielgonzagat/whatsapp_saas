...
export const OPERATOR_INTENT_PATTERNS: Array<{
...
}> = [
  {
    ...
    keywords: ['produto', 'produtos', 'catalogo', 'catalogo de produtos', 'meus produtos', 'listar produtos', 'liste produtos', 'quais produtos', 'mostra produtos', 'ver produtos'],
    examples: ['liste meus produtos', 'mostra o catalogo', 'quais produtos tenho'],
  },
  {
    intent: 'search_contact',
    keywords: ['contato', 'contatos', 'cliente', 'clientes', 'buscar contato', 'procurar contato', 'achar contato', 'encontrar contato', 'pesquisar contato'],
    examples: ['buscar contato joao', 'ache o cliente maria', 'procure o telefone 119'],
  },
  {
    intent: 'list_conversations',
    keywords: ['conversa', 'conversas', 'conversacoes', 'conversas recentes', 'ultimas conversas', 'inbox', 'caixa de entrada', 'mensagens recentes'],
    examples: ['liste conversas recentes', 'conversas abertas', 'mostra a inbox'],
  },
  {
    intent: 'send_message_via_channel',
    keywords: ['enviar mensagem', 'enviar msg', 'mandar mensagem', 'mandar msg', 'disparar mensagem', 'enviar para', 'manda para'],
    examples: ['envia mensagem para 1199999 dizendo ola', 'manda msg para maria'],
  },
  {
    intent: 'query_revenue_summary',
    keywords: ['receita', 'faturamento', 'vendas', 'revenue', 'ganhos', 'lucro', 'quanto vendeu', 'quanto faturei', 'resumo de vendas', 'resumo financeiro', 'financeiro'],
    examples: ['resumo de receita', 'quanto faturei esse mes', 'qual o faturamento'],
  },
];

const UNSUPPORTED_FALLBACK_KEYWORDS = [
  'site', 'landing', 'pagina', 'anuncio', 'anuncios', 'campanha', 'email',
  'relatorio', 'relatorios', 'dashboard', 'configurar', 'integração', 'integracao',
];
