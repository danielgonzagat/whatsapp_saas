...
export const ciaApi = {
  ...
  getAccountRuntime: (workspaceId: string) => {
    return apiFetch<CiaAccountRuntime>(
      `/cia/account-runtime/${encodeURIComponent(workspaceId)}`,
    );
  },
  ...
  getAccountWorkItems: (workspaceId: string) => {
    return apiFetch<CiaWorkItem[]>(
      `/cia/account-work-items/${encodeURIComponent(workspaceId)}`,
    );
  },

  getAccountProof: (workspaceId: string) => {
    return apiFetch<CiaProof>(
      `/cia/account-proof/${encodeURIComponent(workspaceId)}`,
    );
  },

  getCycleProof: (workspaceId: string) => {
    return apiFetch<CiaProof>(
      `/cia/cycle-proof/${encodeURIComponent(workspaceId)}`,
    );
  },
