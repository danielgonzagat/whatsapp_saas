// Pure type definitions for the CIA API. Extracted from cia.ts to keep the
// runtime module focused on request orchestration. Behavior unchanged: cia.ts
// continues to re-export every symbol below for backward compatibility with
// existing callers that import directly from '@/lib/api/cia'.
