...
export const PRODUCT_TEMPLATES: ProductTemplate[] = [
  /* ── 1. Anuncio Produto Premium ── */
  {
    ...
    json: {
      ...
      background: '#0A0A0C',
      objects: [
        { type: 'Rect', left: 0, top: 0, width: 1080, height: 1080, fill: '#0A0A0C', selectable: false, evented: false },
        { type: 'Textbox', left: 100, top: 200, width: 880, text: 'Serum Premium', fontSize: 48, fontWeight: 'bold', fontFamily: 'Sora', fill: '#E0DDD8', textAlign: 'left' },
        { type: 'Textbox', left: 100, top: 270, width: 880, text: 'Regeneracao celular avancada', fontSize: 18, fontFamily: 'Sora', fill: '#6E6E73', textAlign: 'left' },
        { type: 'Rect', left: 100, top: 310, width: 200, height: 4, fill: '#E85D30' },
        { type: 'Rect', left: 100, top: 885, width: 200, height: 44, fill: '#E85D30', rx: 4, ry: 4 },
        { type: 'Textbox', left: 100, top: 892, width: 200, text: 'Comprar agora', fontSize: 14, fontWeight: 'bold', fontFamily: 'Sora', fill: '#0A0A0C', textAlign: 'center' },
      ],
    },
  },
  ...
  /* ── 2. Anuncio Produto B ── */
  {
    ...
    json: {
      ...
      objects: [
        { type: 'Rect', left: 0, top: 0, width: 1080, height: 1080, fill: '#0A0A0C', selectable: false, evented: false },
        { type: 'Textbox', left: 100, top: 200, width: 880, text: 'Seu Produto', fontSize: 48, fontWeight: 'bold', fontFamily: 'Sora', fill: '#E0DDD8', textAlign: 'left' },
        { type: 'Textbox', left: 100, top: 270, width: 880, text: 'Reparacao e Rejuvenescimento', fontSize: 18, fontFamily: 'Sora', fill: '#6E6E73', textAlign: 'left' },
        { type: 'Rect', left: 100, top: 310, width: 200, height: 4, fill: '#E85D30' },
        { type: 'Rect', left: 100, top: 885, width: 200, height: 44, fill: '#E85D30', rx: 4, ry: 4 },
        { type: 'Textbox', left: 100, top: 892, width: 200, text: 'Comprar agora', fontSize: 14, fontWeight: 'bold', fontFamily: 'Sora', fill: '#0A0A0C', textAlign: 'center' },
      ],
  ...
  /* ── 3. Prova Social (Story) ── */
  {
    ...
    json: {
      ...
      background: '#0A0A0C',
      objects: [
        { type: 'Rect', left: 0, top: 0, width: 1080, height: 1920, fill: '#0A0A0C', selectable: false, evented: false },
        { type: 'Textbox', left: 100, top: 200, width: 120, text: '\u201C', fontSize: 120, fontFamily: 'Sora', fill: '#E85D30', textAlign: 'left' },
        { type: 'Textbox', left: 100, top: 300, width: 880, text: 'Escreva o depoimento do cliente aqui. Resultados visiveis em poucas semanas de uso.', fontSize: 20, fontFamily: 'Sora', fill: '#E0DDD8', lineHeight: 1.6, textAlign: 'left' },
        { type: 'Textbox', left: 100, top: 600, width: 880, text: '\u2014 Nome da Cliente', fontSize: 14, fontFamily: 'Sora', fill: '#6E6E73', textAlign: 'left' },
        { type: 'Textbox', left: 100, top: 640, width: 200, text: '\u2605 \u2605 \u2605 \u2605 \u2605', fontSize: 18, fontFamily: 'Sora', fill: '#E85D30', textAlign: 'left' },
        { type: 'Textbox', left: 100, top: 1800, width: 200, text: 'KLOEL', fontSize: 10, fontWeight: 'bold', fontFamily: 'Sora', fill: '#3A3A3F', charSpacing: 400, textAlign: 'left' },
      ],
    },
  },
  ...
  /* ── 4. Antes e Depois ── */
  {
    ...
    json: {
      ...
      objects: [
        ...
        { type: 'Textbox', left: 200, top: 50, width: 160, text: 'ANTES', fontSize: 16, fontWeight: 'bold', fontFamily: 'Sora', fill: '#E0DDD8', charSpacing: 300, textAlign: 'center' },
        { type: 'Textbox', left: 700, top: 50, width: 160, text: 'DEPOIS', fontSize: 16, fontWeight: 'bold', fontFamily: 'Sora', fill: '#E0DDD8', charSpacing: 300, textAlign: 'center' },
      ],
    },
  },
  ...
  /* ── 5. Mockup Frasco ── */
  {
    ...
    json: {
      ...
      objects: [
        { type: 'Rect', left: 0, top: 0, width: 1080, height: 1080, fill: '#0A0A0C', selectable: false, evented: false },
        { type: 'Rect', left: 0, top: 0, width: 1080, height: 1080, fill: '#111113', opacity: 0.5, selectable: false, evented: false },
        { type: 'Textbox', left: 240, top: 150, width: 600, text: 'Nome do Produto', fontSize: 36, fontWeight: 'bold', fontFamily: 'Sora', fill: '#E0DDD8', textAlign: 'center' },
        { type: 'Rect', left: 340, top: 250, width: 400, height: 600, fill: '#1C1C1F', rx: 8, ry: 8 },
        { type: 'Textbox', left: 100, top: 900, width: 880, text: '\u2022  Ingrediente ativo de alta performance', fontSize: 13, fontFamily: 'Sora', fill: '#6E6E73', textAlign: 'left' },
        { type: 'Textbox', left: 100, top: 930, width: 880, text: '\u2022  Resultados clinicamente comprovados', fontSize: 13, fontFamily: 'Sora', fill: '#6E6E73', textAlign: 'left' },
        { type: 'Textbox', left: 100, top: 960, width: 880, text: '\u2022  Tecnologia exclusiva KLOEL', fontSize: 13, fontFamily: 'Sora', fill: '#6E6E73', textAlign: 'left' },
      ],
    },
  },
];
