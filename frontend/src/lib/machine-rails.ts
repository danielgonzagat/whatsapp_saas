...
export const MACHINE_RAILS: Record<MachineShellKey, MachineRailConfig> = {
  ...
  produtos: {
    ...
    links: [
      { label: 'Abrir checkouts', href: '/products?feature=checkout-appearance', hint: 'Visual, cupom, bump e urgencia' },
      { label: 'Publicar site', href: '/sites/criar', hint: 'Levar o produto para uma pagina real' },
      { label: 'Abrir marketing', href: '/marketing', hint: 'Distribuir a oferta pelos canais' },
      { label: 'Ver afiliados', href: '/parcerias/afiliados', hint: 'Programa, materiais e coproducao' },
    ],
  },
  sites: {
    ...
    links: [
      ...
      { label: 'Gerenciar dominios', href: '/sites/dominios', hint: 'DNS, SSL e dominio principal' },
  ...
  marketing: {
    ...
    links: [
      { label: 'Abrir WhatsApp', href: '/marketing/whatsapp', hint: 'Conectar, atender e disparar' },
      ...
      { label: 'Ver analytics', href: '/analytics', hint: 'Ler abandono, satisfacao e exportacoes' },
    ],
  },
  anuncios: {
    ...
    links: [
      { label: 'Abrir rastreamento', href: '/anuncios/rastreamento', hint: 'Pixels, eventos e retargeting' },
      { label: 'Abrir marketing', href: '/marketing', hint: 'Levar audiencia para campanhas e canais' },
      { label: 'Abrir analytics', href: '/analytics?tab=abandonos', hint: 'Ler origem, abandono e resultado' },
      { label: 'Abrir billing', href: '/settings?section=billing', hint: 'Cobranca e estrutura financeira' },
    ],
  },
  vendas: {
    ...
    links: [
      ...
      { label: 'Abrir parceiros', href: '/parcerias/afiliados', hint: 'Afiliados, coproducao e materiais' },
      { label: 'Abrir carteira', href: '/carteira', hint: 'Saldo, saque e movimentacoes' },
      { label: 'Abrir billing', href: '/settings?section=billing', hint: 'Meio de cobranca e configuracao' },
    ],
  },
  carteira: {
    ...
    links: [
      ...
      { label: 'Abrir parceiros', href: '/parcerias/afiliados', hint: 'Comissoes, repasses e coproducao' },
      { label: 'Abrir billing', href: '/settings?section=billing', hint: 'Dados bancarios e cobranca' },
      { label: 'Abrir analytics', href: '/analytics?tab=exportacoes', hint: 'Exportar e conferir o financeiro' },
    ],
  },
  parcerias: {
    ...
    links: [
      ...
      { label: 'Abrir billing', href: '/settings?section=billing', hint: 'Estrutura de pagamento do workspace' },
    ],
  },
};
