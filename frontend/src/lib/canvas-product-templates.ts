...
export const PRODUCT_TEMPLATES: ProductTemplate[] = [
  /* ── 1. Anuncio Produto Premium ── */
  {
    ...
    cat: 'Produto',
    fmt: 'post-ig',
    colors: ['colors.ember.primary', 'colors.background.void'],
    w: 1080,
    h: 1080,
    json: {
      version: '7.0.0',
      ...
      objects: [
        ...
        { type: 'rect', left: 100, top: 310, width: 200, height: 4, fill: 'colors.ember.primary' },
        {
          type: 'rect',
          left: 100,
          top: 885,
  ...
  /* ── 2. Anuncio Produto B ── */
  {
    ...
    cat: 'Produto',
    fmt: 'post-ig',
    colors: ['colors.ember.primary', 'colors.background.surface'],
    w: 1080,
    h: 1080,
    json: {
      version: '7.0.0',
  ...
  /* ── 4. Antes e Depois ── */
  {
    ...
    json: {
      ...
      objects: [
        ...
        { type: 'rect', left: 537, top: 0, width: 6, height: 1080, fill: 'colors.ember.primary' },
        {
          type: 'textbox',
          left: 200,
          top: 50,
