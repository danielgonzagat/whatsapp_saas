...
export const externalBrands = {
  ...
  whatsappDark: '#128C7E',
  whatsappLabel: '#7E7E85',
  whatsappTextSecondary: '#A9A9B0',
  whatsappDangerBg: '#2D1616',
  whatsappSuccessBg: '#17331F',
  whatsappCardBorder: '#26262B',
  whatsappGradientStart: '#161619',
  whatsappGradientEnd: '#0E0E11',
  whatsappCardText: '#D7D7DD',
  whatsappCardTextBright: '#D4D4DA',
  whatsappCardBg: '#0E0E10',
  whatsappButtonText: '#F2F2F5',
  whatsappCardDark: '#1F2C33',
  whatsappBgDark: '#101B20',
  whatsappBubbleBorder: '#2A3942',
  whatsappBubbleBg: '#202C33',
