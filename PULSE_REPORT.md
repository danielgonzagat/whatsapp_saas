# PULSE REPORT — 2026-05-23T23:43:06.116Z
...
- Structural chains: 792/2730 complete
...
- Execution matrix: paths=7032, observedPass=0, observedFail=40, criticalUnobserved=0, unknown=0
- Structural parity gaps: total=42, critical=0, high=41
- Finding events: totalSignals=2, uniqueEvents=2, observed=0, confirmedStatic=2, weakSignals=0
...
- Structural Graph Coverage: 29% (1446/5060 connected)
  Reason: 1446/5060 structural files connected.
- Test Coverage: 18%
  Reason: 701/3864 source modules have spec files.
...
- 2730 structural chains
- 0 real capabilities
- 0 real flows

### Aspirational (product vision projection)
- 38 projected surfaces
- Target: If the currently connected partial and latent structures converge without introducing new phantom paths, the product projects to 420/420 capability(ies) and 75/75 flow(s) at least partially real, with readiness yellow.
...
- codacy/static_hotspot: impact=55%, mode=ai_safe, mappedCapabilities=200, mappedFlows=72, summary=1 HIGH Codacy issue(s) remain in backend/src/meta/__parts__/meta-auth-helpers.ts.
- codacy/static_hotspot: impact=55%, mode=ai_safe, mappedCapabilities=185, mappedFlows=72, summary=1 HIGH Codacy issue(s) remain in backend/src/meta/__parts__/meta-oauth-url.helpers.ts.
...
- Current checkpoint: The current product-facing system materializes 420 partial capability(ies), 0 latent capability(ies). System-wide phantom capability count is 0.
...
- Projected checkpoint: If the currently connected partial and latent structures converge without introducing new phantom paths, the product projects to 420/420 capability(ies) and 75/75 flow(s) at least partially real, with readiness yellow.
...
- Analytics: status=partial, completion=100%, capabilities=166, flows=72
- Autopilot: status=partial, completion=100%, capabilities=187, flows=72
- Billing: status=partial, completion=100%, capabilities=10, flows=72
- Campaigns: status=partial, completion=100%, capabilities=169, flows=72
- Checkout: status=partial, completion=100%, capabilities=179, flows=72
- CIA/Agent: status=partial, completion=100%, capabilities=169, flows=72
- CRM: status=partial, completion=100%, capabilities=167, flows=72
...
- Onboarding: status=partial, completion=100%, capabilities=158, flows=72
- Partnerships: status=partial, completion=100%, capabilities=158, flows=72
...
- Canonical dir: /Users/danielpenin/.config/superpowers/worktrees/whatsapp_saas/pr424-ci-fix/.pulse/current
