# PULSE REPORT — 2026-04-25T03:15:42.931Z
...
- Structural chains: 763/2331 complete
- Capabilities: real=274, partial=24, latent=10, phantom=0
- Capability maturity: foundational=3, connected=233, operational=2, productionReady=70
...
- codacy/static_hotspot: impact=80%, mode=ai_safe, mappedCapabilities=70, mappedFlows=110, summary=2 HIGH Codacy issue(s) remain in backend/src/auth/email.service.ts.
- codacy/static_hotspot: impact=80%, mode=ai_safe, mappedCapabilities=50, mappedFlows=96, summary=1 HIGH Codacy issue(s) remain in backend/src/autopilot/autopilot.service.ts.
...
- Projected checkpoint: If the currently connected partial and latent structures converge without introducing new phantom paths, the product projects to 289/289 capability(ies) and 121/121 flow(s) at least partially real, with readiness yellow.
...
- Anuncios/Ads: status=real, completion=100%, capabilities=74, flows=104, blocker=Missing structural roles: persistence.
...
- CRM: status=real, completion=100%, capabilities=27, flows=106, blocker=Missing structural roles: persistence.
...
- Partnerships: status=real, completion=100%, capabilities=14, flows=63
...
- Analytics: status=real, completion=99%, capabilities=29, flows=96, blocker=Maturity is still missing: runtime_evidence, validation, scenario_coverage, codacy_hygiene.
- Campaigns: status=real, completion=99%, capabilities=54, flows=112, blocker=Maturity is still missing: runtime_evidence, validation, scenario_coverage, codacy_hygiene.
