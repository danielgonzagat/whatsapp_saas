# PULSE REPORT — 2026-05-16T00:06:51.011Z
...
- Structural chains: 804/2733 complete
- Capabilities: real=0, partial=422, latent=8, phantom=0
- Capability maturity: foundational=2, connected=428, operational=0, productionReady=0
- Flows: real=0, partial=76, latent=0, phantom=0
- Execution matrix: paths=6087, observedPass=0, observedFail=40, criticalUnobserved=0, unknown=0
- Structural parity gaps: total=43, critical=0, high=42
...
- Structural Graph Coverage: 31% (1345/4290 connected)
  Reason: 1345/4290 structural files connected.
- Test Coverage: 19%
  Reason: 616/3319 source modules have spec files.
...
- Production Proof Coverage: 0%
  Reason: 0/430 capabilities real.
- Unknown Files: 47
- Orphan Files: 200
...
- 2733 structural chains
- 0 real capabilities
- 0 real flows

### Aspirational (product vision projection)
- 38 projected surfaces
- Target: If the currently connected partial and latent structures converge without introducing new phantom paths, the product projects to 409/409 capability(ies) and 76/76 flow(s) at least partially real, with readiness yellow.

## External Reality

- codacy/static_hotspot: impact=80%, mode=ai_safe, mappedCapabilities=5, mappedFlows=33, summary=7 HIGH Codacy issue(s) remain in backend/prisma/migrations/20251209150035_init_baseline/migration.sql.
...
- codacy/static_hotspot: impact=55%, mode=ai_safe, mappedCapabilities=189, mappedFlows=73, summary=1 HIGH Codacy issue(s) remain in backend/src/meta/__parts__/meta-auth-helpers.ts.
- codacy/static_hotspot: impact=55%, mode=ai_safe, mappedCapabilities=174, mappedFlows=73, summary=1 HIGH Codacy issue(s) remain in backend/src/meta/__parts__/meta-oauth-url.helpers.ts.
...
- Current checkpoint: The current product-facing system materializes 409 partial capability(ies), 0 latent capability(ies). System-wide phantom capability count is 0.
- Inferred product: If the currently connected structures converge, the product resolves toward a unified operational platform centered on Analytics, Autopilot, Billing, Campaigns, Checkout, CIA/Agent, CRM, Dashboard, Followups, Inbox/Chat, Onboarding, Partnerships, Products, Sales/Vendas, Scrapers, Area, Canvas, Carteira, Cookies, Ferramentas, Launch, Media, Parcerias.
- Projected checkpoint: If the currently connected partial and latent structures converge without introducing new phantom paths, the product projects to 409/409 capability(ies) and 76/76 flow(s) at least partially real, with readiness yellow.
- Distance: Distance to projected readiness is driven by 0 product-facing phantom capability(ies), 0 system-wide phantom capability(ies), 0 phantom flow(s), 43 structural parity gap(s), and 2225 HIGH Codacy issue(s).

## Product Surfaces

- Analytics: status=partial, completion=100%, capabilities=167, flows=73
- Autopilot: status=partial, completion=100%, capabilities=192, flows=73
- Billing: status=partial, completion=100%, capabilities=10, flows=73
- Campaigns: status=partial, completion=100%, capabilities=157, flows=73
- Checkout: status=partial, completion=100%, capabilities=169, flows=73
- CIA/Agent: status=partial, completion=100%, capabilities=174, flows=73
- CRM: status=partial, completion=100%, capabilities=167, flows=73
- Dashboard: status=partial, completion=100%, capabilities=7, flows=73
- Followups: status=partial, completion=100%, capabilities=193, flows=73
- Inbox/Chat: status=partial, completion=100%, capabilities=8, flows=73
- Onboarding: status=partial, completion=100%, capabilities=157, flows=73
...
- matrix:capability:capability:admin-chat: status=inferred_only, truth=inferred, mode=governed_validation, route=/ad-rules, breakpoint=Path is structurally inferred but lacks observed runtime, flow, actor, browser, or external evidence.
...
- Front without back: Health System: Capability Health System exposes UI or interaction entry points without an orchestrated backend/materialized effect.
...
- UI without persistence: Health System: Capability Health System has interface presence but still lacks persistence or any durable external effect.
