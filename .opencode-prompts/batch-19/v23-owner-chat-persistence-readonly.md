# MISSAO
Auditar, sem editar, se o chat interno do dono ainda depende de localStorage ou mock/fallback falso em vez de API/banco.

# ARQUIVOS PERMITIDOS
- frontend/src/components/kloel/dashboard/**
...
Nenhuma alteracao. Relatar se D-CHAT/V17 ainda tem uso de localStorage, dados mockados, quick actions sem endpoint real, ou persistencia incompleta.
