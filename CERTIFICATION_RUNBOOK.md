...
- [ ] Blacklist global de CPF, email, IP e device
- [ ] Regras de velocity
- [ ] BIN estrangeiro aumenta score em compra BR
- [ ] Score e thresholds configuraveis
- [ ] Endpoint administrativo de blacklist
- [ ] Log detalhado de decisao
- [ ] Testes de fraude conhecidos
