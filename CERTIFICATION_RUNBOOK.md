...
- Estado certificado nesta tranche:
  ...
  - Os testes focados do módulo Connect estão verdes para criação de contas, status de onboarding, submissão individual, submissão company/tokenized bank account e validações de boundary no controller.
- Escopo ainda nao certificado dentro do Bloco 2:
  - formulários seller-facing por role ainda precisam existir e ser validados ponta a ponta no frontend Kloel;
