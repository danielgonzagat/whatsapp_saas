/**
 * @deprecated Use `backend/src/kloel/mind/cia/cia-runtime-state.service` directly.
 ...
 *
 * @canonical backend/src/kloel/mind/cia/cia-runtime-state.service.ts
 * @see docs/adr/0013-kloel-mind-unification.md
 */
export { CiaRuntimeStateService } from '../kloel/mind/cia/cia-runtime-state.service';
