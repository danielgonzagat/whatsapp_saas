...
import type { LineageGuardVerdict, LineageGuardService } from '../lineage/lineage-guard.service';
 ...
 */
function mockGuard(verdict: Partial<LineageGuardVerdict> = {}): LineageGuardService {
  return {
 ...
 */
function cloneGenesisPayload(overrides?: Partial<GenesisPayload>): GenesisPayload {
 ...
 */
function tamperedGenesisEvent(overrides: {
