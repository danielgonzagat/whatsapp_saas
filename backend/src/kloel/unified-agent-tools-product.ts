    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          customerCpf: { type: 'string', description: 'CPF/CNPJ do comprador' },
          zipCode: { type: 'string', description: 'CEP do comprador' },
          streetName: { type: 'string', description: 'Rua do comprador' },
          streetNumber: { type: 'string', description: 'Numero do endereco do comprador' },
          neighborhood: { type: 'string', description: 'Bairro do comprador' },
          city: { type: 'string', description: 'Cidade do comprador' },
          state: { type: 'string', description: 'UF do comprador' },
        },
        required: [
          'productName',
          'amount',
