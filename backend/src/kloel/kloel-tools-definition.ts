...
import { KLOEL_CHAT_TOOLS_MEDIA_BILLING } from './kloel-tools-definition-b';

/** Core tool schemas (products, automation, metrics, payments, whatsapp, leads, settings, campaigns). */
...
/** Tool schemas available in the main KLOEL chat interface. */
