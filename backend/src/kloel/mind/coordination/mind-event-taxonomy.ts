...
// Commercial event payload interfaces are defined in the sibling part2 module to
// keep this file under the architecture-guardrail line budget. Re-exported here so
// `./mind-event-taxonomy` remains the single canonical import path for all consumers.
export type {
  ...
  CouponEventPayload,
  ConceptEventPayload,
} from './mind-event-taxonomy.part2';
