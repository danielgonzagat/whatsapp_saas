...
const BUILT_IN_POLICIES: readonly ChannelTerminalPolicy[] = [
  {
    ...
    defaultValenceByName: {
      ...
      'commerce.lead.went_silent': 'negative',
      'commerce.whatsapp.conversation_resumed': 'positive',
    },
    defaultTruthModeByName: {
      ...
      'commerce.lead.objection_raised': 'inferred',
      'commerce.lead.went_silent': 'inferred',
      'commerce.whatsapp.conversation_resumed': 'observed',
    },
  },
  {
    channelName: 'web',
  ...
  },
  {
    ...
    defaultValenceByName: {
      ...
      'commerce.post_sale.repurchase_window_opened': 'neutral',
      'commerce.post_sale.win_back_window_opened': 'neutral',
    },
    defaultTruthModeByName: {
      'commerce.post_sale.first_value_obtained': 'inferred',
      'commerce.post_sale.satisfaction_signal_observed': 'observed',
      'commerce.post_sale.churn_risk_detected': 'inferred',
      'commerce.post_sale.repurchase_window_opened': 'inferred',
      'commerce.post_sale.win_back_window_opened': 'inferred',
    },
  },
];
