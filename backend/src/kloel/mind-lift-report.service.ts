/**
 * @deprecated File moved to `kloel/mind/observability/mind-lift-report.service.ts`
 * during ADR-0013 Wave M5 batch 4. This re-export keeps the legacy path live
