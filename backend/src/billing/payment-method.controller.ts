...
export class PaymentMethodController {
  ...
  @Roles('ADMIN', 'OWNER')
  async setDefault(@Req() req: any, @Param('paymentMethodId') paymentMethodId: string) {
    const workspaceId = resolveWorkspaceId(req);
  ...
  @Roles('ADMIN', 'OWNER')
  async detachPaymentMethod(@Req() req: any, @Param('paymentMethodId') paymentMethodId: string) {
    const workspaceId = resolveWorkspaceId(req);
