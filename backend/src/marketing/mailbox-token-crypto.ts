...
export function encryptMailboxToken(token: string | null | undefined): string | null | undefined {
  if (!token) {
    return token;
  }
...
export function decryptMailboxToken(token: string | null | undefined): string | null {
  if (!token) {
    return null;
  }
...
export function isEncryptedMailboxToken(token: string): boolean {
