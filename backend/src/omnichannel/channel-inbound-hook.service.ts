...
import { MindEventProcessorService } from '../kloel/mind/runtime/mind-event-processor.service';
...
export class ChannelInboundHookService {
  ...
  constructor(
    ...
    @Inject(forwardRef(() => MindEventSpine))
    private readonly eventSpine?: MindEventSpine,
  ) {}
