...
--
-- init_baseline_v2 — Topologically sorted DDL so every FK references a table
-- that already exists at the point the CREATE TABLE (or ALTER TABLE) is issued.
-- Supersedes 20251209150035_init_baseline which had DDL ordering issues flagged
-- by Codacy rac-table-access semgrep rule (35-37 HIGH issues).
--
-- RAC_ PREFIX NOTE: This is a new initial baseline (2026-05-10).
-- All tables, indexes, and FK constraints reference unprefixed table names
-- ("Workspace", "Agent", ...). The RAC_ prefix is applied by a later
