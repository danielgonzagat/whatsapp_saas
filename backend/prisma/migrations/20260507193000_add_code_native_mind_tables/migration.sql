CREATE TABLE IF NOT EXISTS "RAC_MindWorkspaceState" (
  "id" TEXT PRIMARY KEY,
  "workspaceId" TEXT NOT NULL UNIQUE REFERENCES "RAC_Workspace"("id") ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS "RAC_MindCase" (
  "id" TEXT PRIMARY KEY,
  "workspaceId" TEXT NOT NULL REFERENCES "RAC_Workspace"("id") ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS "RAC_MindConceptDetection_workspaceId_subject_occurredAt_idx"
...
CREATE UNIQUE INDEX IF NOT EXISTS "RAC_MindGraphEdge_workspaceId_fromNode_relation_toNode_key"
...
CREATE UNIQUE INDEX IF NOT EXISTS "RAC_MindOutboxEvent_workspaceId_idempotencyKey_key"
  ON "RAC_MindOutboxEvent"("workspaceId","idempotencyKey");
CREATE INDEX IF NOT EXISTS "RAC_MindOutboxEvent_workspaceId_eventType_occurredAt_idx"
...
CREATE UNIQUE INDEX IF NOT EXISTS "RAC_MindBanditArm_workspaceId_decisionType_arm_key"
  ON "RAC_MindBanditArm"("workspaceId","decisionType","arm");
CREATE INDEX IF NOT EXISTS "RAC_MindBanditArm_workspaceId_decisionType_isActive_idx"
...
CREATE UNIQUE INDEX IF NOT EXISTS "RAC_MindGlobalPrior_domain_predicate_context_key"
