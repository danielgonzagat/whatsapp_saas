--
-- init_baseline — Topologically sorted DDL so every FK references a table
-- that already exists at the point the CREATE TABLE (or ALTER TABLE) is issued.
--
-- This is the unified canonical baseline (originally 20260510_init_baseline_v2,
-- renamed to preserve the 20251209150035 timestamp for DBs that already applied
-- the original v1 baseline). See MIGRATION_PLAN.md for production db instructions.
--
...
-- DO NOT edit table/constraint names here. If a rule-flagged line here
-- corresponds to a real problem (e.g. missing index on a FK), create
-- a NEW migration instead of altering this baseline.
--
-- DDL ORDERING: Tables are ordered by dependency depth (Kahn's algorithm).
-- Level 0  — no FK dependencies
-- Level 1  — depends only on Level 0
-- Level 2  — depends on Level 1 or earlier
-- Level 3  — depends on Level 2 or earlier
-- Level 4  — depends on Level 3 or earlier
-- Level 5  — depends on Level 4 or earlier

-- CreateExtension
CREATE EXTENSION IF NOT EXISTS vector;

-- ===========================================================================
-- Level 0 — No FK dependencies on other tables
-- ===========================================================================
...
-- ===========================================================================
-- Level 1 — Depends only on Level 0 tables (mostly Workspace)
-- ===========================================================================
...
-- ===========================================================================
-- Level 2 — Depends on Level 1 (or Level 0) tables
-- ===========================================================================
...
-- ===========================================================================
-- Level 3 — Depends on Level 2 (or earlier) tables
-- ===========================================================================
...
-- ===========================================================================
-- Level 4 — Depends on Level 3 (or earlier) tables
-- ===========================================================================
...
-- ===========================================================================
-- Level 5 — Depends on Level 4 (or earlier) tables
-- ===========================================================================
...
-- ===========================================================================
-- Indexes — all tables exist by this point
-- ===========================================================================
...
-- ===========================================================================
-- Foreign Keys — all tables exist by this point, no DDL ordering issues
-- ===========================================================================
