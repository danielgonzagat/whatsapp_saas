...
arquivos.
Se uma regra precisa mudar, a IA deve pedir ao dono do repositorio para fazer a
mudanca.
...
frágil.
Em código novo, SEMPRE usar `this.prisma.` tipado. Migrar `prismaAny`
progressivamente.
...
Usar `colors.ember.primary` (#E85D30) para accent, `colors.text.silver` para
texto.
