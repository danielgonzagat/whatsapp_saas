...
- **Plano executável**:
  [docs/plans/STRIPE_MIGRATION_PLAN.md](../plans/STRIPE_MIGRATION_PLAN.md)

## Contexto

O KLOEL precisava de uma base única para suportar checkout, Pix, webhooks,
ledger, wallet e a futura camada de split multi-stakeholder sem fragmentação
operacional.

A arquitetura anterior de pagamentos estava espalhada em múltiplas superfícies e
impedia:
...
- Pix fica alinhado ao core de venda aprovada, em vez de coexistir com engines
  paralelas.
...
- Necessidade de manter o ambiente live bloqueado até existirem chaves e
  capabilities corretas.

## Invariantes

- Stripe é o único provider ativo de pagamento.
- O ledger Kloel continua sendo a verdade de produto para saldo exibido,
  maturação e payout.
...
- resíduos remanescentes só em superfícies históricas ou protegidas por
  governance.
