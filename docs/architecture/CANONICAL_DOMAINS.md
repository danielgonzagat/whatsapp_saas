...
Total domains: 187. Total files scanned: 3675.

| Domain | Files | Services | Controllers | Modules | Events |
|---|---:|---:|---:|---:|---:|
| `kloel` | 1013 | 360 | 39 | 42 | 69 |
| `frontend/components/kloel` | 553 | 0 | 0 | 0 | 0 |
| `frontend/page/(main)` | 205 | 0 | 0 | 0 | 0 |
| `admin` | 168 | 35 | 25 | 24 | 1 |
| `marketing` | 159 | 47 | 19 | 0 | 5 |
| `frontend/lib` | 143 | 0 | 0 | 0 | 11 |
| `common` | 88 | 21 | 2 | 4 | 2 |
| `frontend/page/(checkout)` | 82 | 0 | 0 | 0 | 0 |
| `frontend/page/api` | 78 | 0 | 0 | 0 | 0 |
| `checkout` | 66 | 13 | 2 | 0 | 3 |
| `worker/autopilot` | 59 | 0 | 0 | 0 | 0 |
| `auth` | 58 | 16 | 2 | 0 | 1 |
| `payments` | 50 | 15 | 3 | 1 | 0 |
| `worker/root` | 50 | 0 | 0 | 0 | 9 |
