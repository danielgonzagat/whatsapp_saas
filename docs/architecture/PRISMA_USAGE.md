...
| `mindPolicy` | 6 | `backend/src/admin/mind/admin-mind.service.ts`<br>`backend/src/kloel/kloel-reflexivity.service.ts`<br>`backend/src/kloel/mind/coordination/mind-commercial-graph.service.ts`<br>… +3 |
...
| `productUrl` | 5 | `backend/src/kloel/kloel-chat-tools.product.helpers.ts`<br>`backend/src/kloel/kloel-product-sub-resource-tools.service.ts`<br>`backend/src/kloel/kloel-product-sub-resource-tools.url-payment.helpers.ts`<br>… +2 |
...
| `mindPrediction` | 3 | `backend/src/admin/mind/admin-mind.service.ts`<br>`backend/src/kloel/mind/inference/mind-predictor.service.ts`<br>`backend/src/kloel/mind/observability/mind-observability.service.ts` |
...
| `mindConceptDetection` | 3 | `backend/src/kloel/mind/memory/mind-concepts.service.ts`<br>`backend/src/kloel/mind/observability/mind-observability.service.ts`<br>`backend/src/kloel/mind/observability/mind-report.service.ts` |
| `mindWorkspaceState` | 3 | `backend/src/kloel/mind/memory/mind-workspace-state.service.ts`<br>`backend/src/kloel/mind/observability/mind-observability.service.ts`<br>`backend/src/kloel/mind/observability/mind-report.service.ts` |
...
| `mindDailyReport` | 2 | `backend/src/kloel/kloel-reflexivity.service.ts`<br>`backend/src/kloel/mind/observability/mind-report.service.ts` |
...
| `mindGraphEdge` | 2 | `backend/src/kloel/mind/coordination/mind-commercial-graph.persistence.ts`<br>`backend/src/kloel/mind/observability/mind-observability.service.ts` |
...
| `mindCase` | 2 | `backend/src/kloel/mind/memory/mind-case-memory.service.ts`<br>`backend/src/kloel/mind/observability/mind-observability.service.ts` |
...
| `mindGraphNode` | 1 | `backend/src/kloel/mind/coordination/mind-commercial-graph.persistence.ts` |
