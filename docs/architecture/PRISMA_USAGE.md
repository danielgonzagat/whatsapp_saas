...
|---|---:|---|
| `workspace` | 133 | `backend/src/admin/accounts/admin-accounts.service.ts`<br>`backend/src/admin/accounts/queries/detail-account.query.ts`<br>`backend/src/admin/accounts/queries/list-accounts.query.ts`<br>… +130 |
...
| `product` | 53 | `backend/src/admin/accounts/queries/detail-account.query.ts`<br>`backend/src/admin/accounts/queries/list-accounts.query.ts`<br>`backend/src/admin/clients/admin-clients.service.ts`<br>… +50 |
| `kloelMemory` | 53 | `backend/src/cia/cia-cognitive-health.service.ts`<br>`backend/src/cia/cia-runtime.service.ts`<br>`backend/src/cia/cia.service.ts`<br>… +50 |
...
| `kloelSale` | 23 | `backend/src/admin/transactions/admin-transactions.service.ts`<br>`backend/src/analytics/advanced-analytics.service.ts`<br>`backend/src/analytics/analytics.service.ts`<br>… +20 |
| `auditLog` | 23 | `backend/src/audit/audit.service.ts`<br>`backend/src/autopilot/autopilot-cycle-money.service.ts`<br>`backend/src/autopilot/autopilot.service.ts`<br>… +20 |
...
| `metaConnection` | 13 | `backend/src/campaigns/campaigns.service.ts`<br>`backend/src/cia/cia.service.ts`<br>`backend/src/integrations/ads-sync-persistence.helpers.ts`<br>… +10 |
...
| `productPlan` | 9 | `backend/src/kloel/kloel-chat-tools.additional.helpers.ts`<br>`backend/src/kloel/kloel-chat-tools.product.helpers.ts`<br>`backend/src/kloel/kloel-chat-tools.service.ts`<br>… +6 |
...
| `pipelineState` | 4 | `backend/src/admin/pipeline/admin-pipeline.service.ts`<br>`backend/src/cia/cia.service.ts`<br>`backend/src/kloel/commercial-decision-orchestrator/gating.ts`<br>… +1 |
...
| `mindBelief` | 4 | `backend/src/kloel/brain-commercial-graph.service.ts`<br>`backend/src/kloel/mind/inference/mind-belief.service.ts`<br>`backend/src/kloel/mind/observability/mind-observability.service.ts`<br>… +1 |
...
| `mindGraphEdge` | 2 | `backend/src/kloel/brain-commercial-graph.persistence.ts`<br>`backend/src/kloel/mind/observability/mind-observability.service.ts` |
