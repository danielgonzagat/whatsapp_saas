...
Total cross-file duplicates: 346. Sorted by severity (most-duplicated first).
...
| `GET` | 36 | `frontend/src/app/api/auth/apple/start/route.ts`<br>`frontend/src/app/api/auth/callback/apple/route.ts`<br>`frontend/src/app/api/auth/callback/tiktok/route.ts`<br>… +33 more |
...
| `clamp` | 4 | `backend/src/common/math.ts`<br>`backend/src/kloel/evol/types.ts`<br>`backend/src/payments/split/split.engine.ts`<br>… +1 more |
...
| `formatCurrency` | 4 | `frontend/src/app/(main)/autopilot/page.ui.tsx`<br>`frontend/src/components/kloel/home/HomeScreen.helpers.ts`<br>`frontend/src/components/kloel/settings/brain-settings-section.helpers.ts`<br>… +1 more |
...
| `extractErrorMessage` | 3 | `backend/src/kloel/kloel-code-tools.service.helpers.ts`<br>`backend/src/prisma/prisma.service.helpers.ts`<br>`frontend/src/components/kloel/inbox/inbox-workspace-utils.ts` |
| `ComposerCapability` | 3 | `backend/src/kloel/kloel-composer.service.helpers.ts`<br>`backend/src/kloel/kloel-thinker-streaming-composer.branch.ts`<br>`backend/src/kloel/kloel.service.composer.helpers.ts` |
...
| `useClientMounted` | 3 | `frontend/src/components/kloel/KloelMarkdownClient.ts`<br>`frontend/src/hooks/useClientMounted.ts`<br>`frontend-admin/src/lib/use-client-mounted.ts` |
...
| `formatInteger` | 3 | `frontend/src/components/kloel/home/HomeScreen.helpers.ts`<br>`frontend-admin/src/app/(admin)/_components/admin-formatters.ts`<br>`frontend-admin/src/app/(admin)/produtos/page.helpers.ts` |
...
| `formatMoney` | 3 | `frontend/src/components/kloel/marketing/WhatsAppExperience.helpers.ts`<br>`frontend/src/lib/common/money.ts`<br>`frontend-admin/src/app/(admin)/produtos/page.helpers.ts` |
...
| `sha256Hex` | 2 | `backend/src/admin/common/admin-crypto.ts`<br>`backend/src/common/auth-core/opaque-token.ts` |
...
| `isAutopilotPerceptEmitEnabled` | 2 | `backend/src/autopilot/autopilot-percept-emit.flag.ts`<br>`worker/processors/autopilot/autopilot-percept-emit.flag.ts` |
| `emitAutopilotActionExecutedPercept` | 2 | `backend/src/autopilot/autopilot-percept-emit.helper.ts`<br>`worker/processors/autopilot/autopilot-percept-emit.helper.ts` |
