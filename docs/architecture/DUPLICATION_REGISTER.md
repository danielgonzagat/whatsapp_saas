...
Total cross-file duplicates: 273. Sorted by severity (most-duplicated first).
...
| `clamp` | 3 | `backend/src/common/math.ts`<br>`backend/src/kloel/evol/types.ts`<br>`frontend/src/components/kloel/AgentCursor.helpers.ts` |
...
| `FollowupListItem` | 3 | `backend/src/kloel/kloel-lead-processor.service.ts`<br>`backend/src/kloel/kloel.service.lists.helpers.ts`<br>`backend/src/kloel/kloel.service.ts` |
