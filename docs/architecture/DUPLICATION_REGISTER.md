...
Total cross-file duplicates: 339. Sorted by severity (most-duplicated first).
...
| `sleep` | 2 | `backend/src/common/async-sequence.ts`<br>`worker/providers/whatsapp-engine.helpers.ts` |
