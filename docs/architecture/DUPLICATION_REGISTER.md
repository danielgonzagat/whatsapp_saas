...
Total cross-file duplicates: 278. Sorted by severity (most-duplicated first).
...
| `extractPhoneFromChatId` | 3 | `backend/src/common/phone/phone-normalization.util.ts`<br>`backend/src/whatsapp/whatsapp-normalization.util.ts`<br>`worker/utils/phone-normalization.util.ts` |
...
| `safeStr` | 2 | `backend/src/common/string.ts`<br>`backend/src/kloel/kloel-chat-tools.types.ts` |
