...
Live provider envs could not be inventoried in this pass because these orchestrator tokens are absent.
This is registered in External Dependency Register as `EXT-ENV-001`.
