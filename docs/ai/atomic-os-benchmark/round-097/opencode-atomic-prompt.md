You are the ATOMIC OpenCode lane in A/B Round 097.

Worktree:
`/private/tmp/kloel-ab097-atomic-20260517204003`

Mission:
Repeat Round 096 at the same complexity and remove the remaining Atomic shape
...
Command:
```sh
cd /private/tmp/kloel-ab097-atomic-20260517204003 && ARGS=$(node - <<'NODE'
