You are the ATOMIC OS Codex A/B worker for Round 132.

Workspace:

`/private/tmp/kloel-ab132-atomic-20260518021318`
...
- Read the compiled policy:
  `/Users/danielpenin/whatsapp_saas/docs/ai/atomic-os-benchmark/round-132-codex-20260518021318/atomic-fastpath.json`
- Follow the selected shape: `single_runtime_module`.
- The current selector chose one runtime module because facade pressure,
  inventory pressure, dependency boundary pressure, source-file count, and write
  batch count were the measured economy winners.
...
node /Users/danielpenin/whatsapp_saas/docs/ai/atomic-os-benchmark/tools/refactor-scorecard.cjs --worktree /private/tmp/kloel-ab132-atomic-20260518021318 --target backend/src/kloel/unified-agent.service.ts --class UnifiedAgentService --spec backend/src/kloel/unified-agent.service.spec.ts --enforce-scope --allow-prefix backend/src/kloel/unified-agent --allow-atomic-traces --fastpath-policy /Users/danielpenin/whatsapp_saas/docs/ai/atomic-os-benchmark/round-132-codex-20260518021318/atomic-fastpath.json --enforce-fastpath-policy --enforce-target-dominance-release --enforce-facade-private-helper-release --enforce-facade-type-surface-release --enforce-type-spillover-economy --enforce-extraction-economy --enforce-sibling-reuse --enforce-trace-economy --enforce-public-api --json
node /Users/danielpenin/whatsapp_saas/docs/ai/atomic-os-benchmark/tools/typecheck-impact-audit.cjs --worktree /private/tmp/kloel-ab132-atomic-20260518021318 --allow-prefix backend/src/kloel/unified-agent --json -- npm --prefix backend run typecheck
