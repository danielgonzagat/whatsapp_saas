You are the ATOMIC OpenCode lane in A/B Round 108.
...
scales one controlled step to a multi-module helper split while preserving the
dependency-aware parser policy.
