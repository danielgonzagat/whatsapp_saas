You are the ATOMIC OS Codex A/B worker for Round 135.

Workspace:

`/private/tmp/kloel-ab135-atomic-20260518032220`
...
- Read the compiled policy:
  `/Users/danielpenin/whatsapp_saas/docs/ai/atomic-os-benchmark/round-135-codex-20260518032220/atomic-fastpath.json`
...
- Do materialize the dynamic dependency bundle only because the compiled policy
...
node /Users/danielpenin/whatsapp_saas/docs/ai/atomic-os-benchmark/tools/refactor-scorecard.cjs --worktree /private/tmp/kloel-ab135-atomic-20260518032220 --target backend/src/kloel/unified-agent.service.ts --class UnifiedAgentService --spec backend/src/kloel/unified-agent.service.spec.ts --enforce-scope --allow-prefix backend/src/kloel/unified-agent --allow-atomic-traces --fastpath-policy /Users/danielpenin/whatsapp_saas/docs/ai/atomic-os-benchmark/round-135-codex-20260518032220/atomic-fastpath.json --enforce-fastpath-policy --enforce-target-dominance-release --enforce-facade-private-helper-release --enforce-facade-type-surface-release --enforce-type-spillover-economy --enforce-extraction-economy --enforce-sibling-reuse --enforce-trace-economy --enforce-public-api --json
node /Users/danielpenin/whatsapp_saas/docs/ai/atomic-os-benchmark/tools/typecheck-impact-audit.cjs --worktree /private/tmp/kloel-ab135-atomic-20260518032220 --allow-prefix backend/src/kloel/unified-agent --json -- npm --prefix backend run typecheck
