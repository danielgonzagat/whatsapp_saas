You are the ATOMIC OpenCode lane in A/B Round 090.

Worktree:
`/private/tmp/kloel-ab090-atomic-20260517180307`

Mission:
Repeat Round 089 at the same complexity after the lint residual. Extract the
...
Command:
```sh
cd /private/tmp/kloel-ab090-atomic-20260517180307 && ARGS=$(node - <<'NODE'
