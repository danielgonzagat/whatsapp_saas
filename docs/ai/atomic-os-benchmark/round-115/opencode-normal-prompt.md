You are the NORMAL OpenCode lane in A/B Round 115.

Worktree:
`/Users/danielpenin/kloel-ab-worktrees/kloel-ab115-normal-20260518060703`
...
shell commands, but you must not use Atomic OS tooling. This round repeats the
same four-helper task because the previous round had an ATOMIC functional pass
but the NORMAL lane hit max_timeout with lint failure.
