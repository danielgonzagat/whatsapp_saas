You are the NORMAL OpenCode lane in A/B Round 094.

Worktree:
`/private/tmp/kloel-ab094-normal-20260517192409`

Mission:
Repeat Round 093 at the same complexity. Solve the real Kloel refactor using
