You are the NORMAL OpenCode lane in A/B Round 098.

Worktree:
`/Users/danielpenin/kloel-ab-worktrees/kloel-ab098-normal-20260517210129`

Mission:
Repeat Round 097 at the same complexity. Solve the real Kloel refactor using
