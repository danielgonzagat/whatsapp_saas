You are the ATOMIC OpenCode lane in A/B Round 089.

Worktree:
`/private/tmp/kloel-ab089-atomic-20260517173646`

Mission:
Escalate one controlled step beyond Round 088. Extract the tool-router helper
cluster plus the action success classifier from
...
Command:
```sh
cd /private/tmp/kloel-ab089-atomic-20260517173646 && ARGS=$(node - <<'NODE'
