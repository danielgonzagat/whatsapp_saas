You are the NORMAL OpenCode lane in A/B Round 103.

Worktree:
`/Users/danielpenin/kloel-ab-worktrees/kloel-ab103-normal-20260517222550`
...
- Preserve public `async executeTool(...)` and `async buildQuotedReplyPlan(...)`
  in the service.
- Do not create `toolRouterDeps()`; if dependencies are grouped, use an explicit
  property/object.
