...
Worktree: `/private/tmp/kloel-ab048-atomic-20260516234505`.
...
- Every MCP `file`, `dir`, `cwd`, and `allowedPaths` argument must be absolute
  and under `/private/tmp/kloel-ab048-atomic-20260516234505`.
...
8. Run:
   `node /Users/danielpenin/whatsapp_saas/docs/ai/atomic-os-benchmark/tools/trace-isolation-check.cjs --worktree /private/tmp/kloel-ab048-atomic-20260516234505 --coordinator /Users/danielpenin/whatsapp_saas --since '<your start time>' --json`
