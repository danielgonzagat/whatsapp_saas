#!/usr/bin/env bash
set -euo pipefail
R="/Users/danielpenin/whatsapp_saas/docs/ai/atomic-os-benchmark/round-122"
W="/Users/danielpenin/kloel-ab-worktrees/kloel-ab122-atomic-20260518085114"
cd "$W"
...
call_atomic atomic_apply_eslint_dry_run_fixes '{"cwd":"backend","args":["src/kloel/unified-agent.service.ts","src/kloel/unified-agent-tool-router.helpers.ts","src/kloel/unified-agent-runtime.helpers.ts","src/kloel/unified-agent-tool-parser.helpers.ts","src/kloel/unified-agent-cognitive-state.helpers.ts","src/kloel/unified-agent-incoming-message.helpers.ts","src/kloel/unified-agent-tool-call-processing.helpers.ts","--fix-dry-run","--fix-type","layout","--format","json"],"allowedPaths":["backend/src/kloel/unified-agent.service.ts","backend/src/kloel/unified-agent-tool-router.helpers.ts","backend/src/kloel/unified-agent-runtime.helpers.ts","backend/src/kloel/unified-agent-tool-parser.helpers.ts","backend/src/kloel/unified-agent-cognitive-state.helpers.ts","backend/src/kloel/unified-agent-incoming-message.helpers.ts","backend/src/kloel/unified-agent-tool-call-processing.helpers.ts"],"applyKnownResidueFixes":false}'
