You are the ATOMIC OpenCode lane in A/B Round 096.

Worktree:
`/private/tmp/kloel-ab096-atomic-20260517202616`

Mission:
Repeat Round 095 at the same complexity and remove the remaining Atomic shape
...
Command:
```sh
cd /private/tmp/kloel-ab096-atomic-20260517202616 && ARGS=$(node - <<'NODE'
