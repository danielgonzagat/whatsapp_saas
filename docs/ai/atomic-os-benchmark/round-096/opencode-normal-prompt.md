You are the NORMAL OpenCode lane in A/B Round 096.

Worktree:
`/private/tmp/kloel-ab096-normal-20260517202616`

Mission:
Repeat Round 095 at the same complexity. Solve the real Kloel refactor using
