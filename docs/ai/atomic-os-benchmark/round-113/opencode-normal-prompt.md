You are the NORMAL OpenCode lane in A/B Round 113.

Worktree:
`/Users/danielpenin/kloel-ab-worktrees/kloel-ab113-normal-20260518052449`
...
shell commands, but you must not use Atomic OS tooling. The previous accepted
round confirmed the three-helper split; this round scales one controlled step by
adding a fourth real helper extraction.
