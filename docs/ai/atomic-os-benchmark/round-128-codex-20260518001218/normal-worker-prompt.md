# Round 128 Normal Worker Prompt
...
```txt
/private/tmp/kloel-ab128-normal-20260518001218
```
...
Final report must include files changed, validation results, first durable code write timestamp if you can determine it, and risks/blockers.
