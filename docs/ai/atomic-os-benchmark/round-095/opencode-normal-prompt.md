You are the NORMAL OpenCode lane in A/B Round 095.

Worktree:
`/private/tmp/kloel-ab095-normal-20260517195614`

Mission:
Repeat Round 094 at the same complexity. Solve the real Kloel refactor using
