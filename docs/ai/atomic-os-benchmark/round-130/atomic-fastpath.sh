#!/usr/bin/env bash
set -euo pipefail
R="/Users/danielpenin/whatsapp_saas/docs/ai/atomic-os-benchmark/round-130"
W="/Users/danielpenin/kloel-ab-worktrees/kloel-ab130-atomic-20260518100157"
cd "$W"
...
call_atomic atomic_replace_text "$(read_json "$R/atomic-facade-router-replace-args.json")"
call_atomic atomic_replace_text "$(read_json "$R/atomic-facade-parser-replace-args.json")"
call_atomic atomic_replace_text "$(read_json "$R/atomic-facade-cognitive-replace-args.json")"
call_atomic atomic_replace_text "$(read_json "$R/atomic-facade-tool-call-processing-replace-args.json")"
call_atomic atomic_replace_text "$(read_json "$R/atomic-facade-predecided-processing-replace-args.json")"
call_atomic atomic_replace_text "$(read_json "$R/atomic-facade-incoming-replace-args.json")"
call_atomic atomic_replace_text "$(read_json "$R/atomic-facade-service-replace-args.json")"
