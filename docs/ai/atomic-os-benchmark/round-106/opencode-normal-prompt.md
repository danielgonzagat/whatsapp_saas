You are the NORMAL OpenCode lane in A/B Round 106.
...
Round 106 correction:
- Round 105 failed because the Atomic lane used `parseToolArgs(...)` before the
  service imported it.
- In this round the service must use
