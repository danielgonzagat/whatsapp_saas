...
Worktree: `/private/tmp/kloel-ab052-atomic-20260517074551`.
...
- Every atomic `file`, `dir`, `cwd`, and `allowedPaths` argument must be
  absolute and under `/private/tmp/kloel-ab052-atomic-20260517074551`.
...
7. Run:
   `node /Users/danielpenin/whatsapp_saas/docs/ai/atomic-os-benchmark/tools/trace-isolation-check.cjs --worktree /private/tmp/kloel-ab052-atomic-20260517074551 --coordinator /Users/danielpenin/whatsapp_saas --since '<your start time>' --json`
