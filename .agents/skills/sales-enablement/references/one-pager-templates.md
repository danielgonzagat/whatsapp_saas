...
discussed and proposes next steps.
...
leadership. Written to make them look smart.
...
4. **Proof elements** — Metrics and quotes should visually stand out (larger
   font, color, or callout box)
