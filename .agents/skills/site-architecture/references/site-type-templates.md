...
Blog | Help | [Cart icon] [Account icon]
...
Examples, Changelog — with expandable subsections
...
Docs | Integrations | [Start Free Trial]

Use mega menus for Product (features list), Solutions (use cases + industries),
and Resources (blog, guides, templates, webinars, case studies).
...
should be reachable from the header.
