...
// Perfectness Test Harness — Time Engine (Part 4)
//
// Time utilities, long-run evidence computation, and state file helpers.
...
export function readStateFile<T>(pulseDir: string, fileName: string): T | null {
