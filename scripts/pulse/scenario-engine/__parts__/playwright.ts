/**
 * PULSE Wave 5 — Playwright Spec & Dynamic Plan Generator
 *
 * Part of the Scenario Evidence Engine. Generates Playwright-compatible
 * test specs, evidence links, preconditions, and dynamic scenario plans.
 */
import { deriveHttpStatusFromObservedCatalog } from '../../dynamic-reality-kernel';
import { isObservedMutatingMethod, toPlaywrightHttpMethod } from '../../dynamic-reality-grammar';
