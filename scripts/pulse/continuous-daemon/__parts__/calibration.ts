/**
 * Part 2: calibration — buildDaemonCalibration, core calibration derivations,
 * and computeCurrentScore.
 */
...
import {
  deriveFileEvidenceDeficits,
  deriveKindPriority,
  deriveRiskPriority,
  deriveFileRiskImpact,
} from './calibration-extra';
...
function deriveLeaseTtlMs(
  ...
  let graphAgeMs = Number.isFinite(graphGeneratedAt)
    ? Date.now() - graphGeneratedAt
    : deriveZeroValue();
