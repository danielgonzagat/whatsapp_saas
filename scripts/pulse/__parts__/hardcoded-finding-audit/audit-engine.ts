...
import type {
  HardcodedFindingAuditFinding,
  HardcodedFindingAuditSource,
  HardcodedFindingAuditFile,
} from './types';
import {
  MIN_COLLECTION_SIZE,
...
export function auditSource(input: HardcodedFindingAuditSource): HardcodedFindingAuditFile {
