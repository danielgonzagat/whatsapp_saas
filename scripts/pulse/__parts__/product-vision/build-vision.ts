...
import { projectionBand, chooseTruthMode, summarizeEvidenceBasis, bestStatus } from './projection';
import { mergeModules, unitHitsModule, runHitsModule } from './families';
import { buildSurfaceBlockers, buildCapabilityCompletion } from './surfaces';
