...
export function isRealExecutedCycle(record: PulseAutonomyIterationRecord): boolean {
...
export function isCodexExecutionPassing(record: PulseAutonomyIterationRecord): boolean {
...
export function evaluateValidation(record: PulseAutonomyIterationRecord): {
...
export function evaluateAdapters(record: PulseAutonomyIterationRecord): {
...
export function evaluateExecutionMatrixNonRegression(record: PulseAutonomyIterationRecord): {
...
export function isScoreNonRegressing(record: PulseAutonomyIterationRecord): boolean {
 ...
 */
export function isBlockingTierNonRegressing(record: PulseAutonomyIterationRecord): boolean {
...
export function formatCycleLabel(record: PulseAutonomyIterationRecord, index: number): string {
  return `cycle${record.iteration ?? index + 1}`;
}

export function formatNumericTransition(before: number | null, after: number | null): string {
...
export function analyzeCycle(record: PulseAutonomyIterationRecord): CycleAnalysis {
