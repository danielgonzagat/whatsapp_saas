...
export const RAC_PATTERN = 'Semgrep_codacy.generic.sql.rac-table-access';

export function makeIssue(overrides: Partial<PulseCodacyIssue> = {}): PulseCodacyIssue {
  return {
...
export function writeFile(rootDir: string, relativePath: string, content: string): string {
...
export function makeEvidenceFingerprint(
...
export function makeFindingId(issue: PulseCodacyIssue): string {
...
export function makeAdjudicatedFinding(
...
export function makeAdjudicationState(
...
export function makeSummary(overrides: Partial<PulseCodacySummary> = {}): PulseCodacySummary {
  return {
...
export function makeScopeState(rootDir: string, codacy: PulseCodacySummary): PulseScopeState {
  return {
    generatedAt: '2026-04-29T00:00:00.000Z',
    rootDir,
    summary: {
...
export function governedValidationAction(result: CodacyClassification): string | undefined {
