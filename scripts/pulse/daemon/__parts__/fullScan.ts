...
import { detectFacades } from '../../parsers/facade-detector/__parts__/facade-detector-part3-main';
...
import { parseUIElements } from '../../parsers/ui-parser/__parts__/parse-ui-elements';
...
import { runPerfectnessScan } from './perfectness-scan';
...
export async function fullScan(
  ...
  await runPerfectnessScan(config, options, structuralGraph);
