...
const CANONICAL_ARTIFACTS: PulseArtifactDefinition[] = [
  ...
  { id: 'path-proof-tasks', relativePath: 'PULSE_PATH_PROOF_TASKS.json' },
  optionalEvidence('path-proof-evidence', 'PULSE_PATH_PROOF_EVIDENCE.json'),
  { id: 'command-graph', relativePath: 'PULSE_COMMAND_GRAPH.json' },
  { id: 'finding-validation-state', relativePath: 'PULSE_FINDING_VALIDATION_STATE.json' },
  { id: 'no-hardcoded-reality-state', relativePath: 'PULSE_NO_HARDCODED_REALITY.json' },
