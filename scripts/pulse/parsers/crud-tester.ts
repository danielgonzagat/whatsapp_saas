 ...
 * Emits CRUD runtime evidence failures; diagnostic identity is synthesized downstream.
 */
...
function crudFinding(input: { description: string; detail: string }): Break {
  return {
    type: 'runtime-flow-evidence-failure',
    severity: 'high',
    file: 'backend/src/products',
    line: 0,
    description: input.description,
    detail: input.detail,
    source: 'runtime:e2e:crud',
    surface: 'crud-flow',
  };
}
