...
import { extractLabel } from './label-extraction';
import { extractComponent } from './component-utils';
import { extractJSXHandler, expandInlineHandler, DOM_HANDLER_PROPS } from './jsx-parser';
import {
  extractApiImports,
  isTestOrSpecFile,
  hasButtonSemantics,
