// PULSE — AST Graph Symbol Resolution
// TypeChecker-based resolution of call expressions, decorators, JSX, and imports.

import { Node } from 'ts-morph';
import type { AstTargetSymbol, AstTypeChecker } from './core-utils';

export function resolveAliasedSymbol(
  symbol: import('./core-utils').TsMorphSymbol | undefined,
