...
export {
  ...
  LINON_DIGIT_RE,
  D__D_S____S_DOE_RE,
  MEU_NOME____S_E__S_RE,
  ASSINADO______S__ATEN_RE,
  N_RE,
  W________W_______A_ZA_RE,
  RX_55_S__________D_2_RE,
  PRE_C__O_VALOR_QUANTO_CU_RE,
  PRAZO_ENTREGA_QUANDO_CHE_RE,
  PIX_CART_A__O_BOLETO_PAG_RE,
  RESULTADO_FUNCIONA_COMO_RE,
  PROBLEMA_DOR_DIFICULDADE_RE,
  S_S_RE,
