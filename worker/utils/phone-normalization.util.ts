/**
 * Worker mirror of the canonical cross-channel phone normalization util.
 *
 * Source of truth: backend/src/common/phone/phone-normalization.util.ts
 *   (canonical per ADR-0012 — OmniCore). This file MUST be byte-identical
 *   with the canonical from the `const NON_DIGIT_RE` line down. The
 *   docblock above the canonical is preserved at the bottom of this header
 *   so future readers don't need to leave the worker tree to understand
 *   the contract.
 *
 ...
 *   (Wave 3D companion). When that script lands, any divergence between
 *   this file and the canonical breaks pre-push and CI.
 *
 * --------------------------------------------------------------------
 * (Canonical docblock — kept verbatim from the backend file below.)
 *
