...
- **Auto-Generates** a Reactivation Campaign with AI-written copy tailored to
  bring them back.
...
3. The system will report how many leads were found and create a campaign in the
   **Campanhas** tab.
...
- **Worker:** BullMQ (Processors: `autopilot-processor` , `crm-processor` ,
  `memory-processor` ).
