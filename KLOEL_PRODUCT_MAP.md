...
| **Canvas** | USER_FACING | PARTIAL | NO | 5 | canvas | 5 page(s), 74 interaction(s), 15 backend-bound, 4 persisted, 0/0 backed data source(s), shell=rich; derived directly from codebase truth. |
...
| products-product-management | FEATURE_FLOW | MATCHED | Products | /products/:id | /products, /products/:productId/affiliates/links/:linkId, /products/:productId/campaigns/:campaignId/pause, /products... |
...
| shared-auth-recovery | SHARED_CAPABILITY | MATCHED | Analytics, Auth, Marketing, Products, Settings, Tools | /analytics, /ferramentas/ver-todas, /login, /marketing, /products, /settings | /api/auth/forgot-password |
...
| shared-campaign-execution | SHARED_CAPABILITY | GROUPED | Ads, Marketing | /anuncios, /marketing | /campaign/start |
| shared-crm-contact-management | SHARED_CAPABILITY | GROUPED | Marketing, Products, Sales, Scrapers, Tools, Video/Voice | /ferramentas, /marketing, /products/:id/plans/:planId, /scrapers, /vendas, /v... | /crm/contacts/:phone/tags/:tag |
| shared-crm-deal-management | SHARED_CAPABILITY | GROUPED | CIA/Agent, CRM/Leads, Canvas, Checkout, Flows, Inbox/Chat, Marketing, Onboard... | /canvas/editor, /checkout/:planId, /cia, /ferramentas/launchpad, /flow, /inbo... | /crm/deals/:id |
...
- Admin scenarios: 3
- Soak scenarios: 3
- Covered user-facing pages: 93/93